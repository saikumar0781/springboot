...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="/hommie">BookWorm</a>
			...
			<tbody>
				<c:forEach items="${book }" var="book">
					<tr>
						...
						<td><a	href="/admin/delete/${book.bookId}"><i class="fa fa-trash"></i></a>  
						<a style="margin: 7.5%"
							href="/admin/update/${book.bookId}"><i
								class="fa fa-bookmark-o" style="color: black"></i></a> 
						</td>
